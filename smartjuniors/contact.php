...
<html lang="en">
	<head>
		...
		<title>Contact | Smart Juniors School</title>
				...
				<div class="primary-header">
					<div class="container">
						<a href="index.html" id="branding">
							<img src="dummy/logo.png" alt="Smart Juniors">
						...
						<div class="col-md-6">
							<form action="MAILTO:smartjuniors.info@gmail.com" class="contact-form">
								...
								<p>
									...
									<span class="control"><input type="text" id="website" placeholder="Mobile number"></span>
								</p>
								<p>
						...
						<div class="col-md-6">
							<div class="contact-info">
								<address>
									...
									<p>Smart Juniors <br>F-19, P.C. COLONY, KANKARBAGH, PATNA <br>Pin Code:-800020</p>
								</address>
								<div class="contact">
